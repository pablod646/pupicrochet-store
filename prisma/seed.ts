...
async function main() {
  ...
  await prisma.product.create({
    data: {
      ...
      description:
        "Un adorable pulpo tejido a mano con hilo de algodón hipoalergénico, perfecto para los más pequeños. Suave y seguro para abrazar.",
      price: 1500,
      dimensions: "Aprox. 15cm de alto x 10cm de ancho",
      materials:
        "Hilo de algodón 100% hipoalergénico, relleno de fibra sintética.",
  ...
  await prisma.product.create({
    data: {
      ...
      description:
        "Sonajero de madera natural y crochet con un diseño de elefante. Estimula los sentidos del bebé con su sonido suave y diferentes texturas.",
      price: 1200,
      dimensions: "12cm de largo",
      materials:
        "Madera de haya sin tratar, hilo de algodón, cascabel interno.",
  ...
  await prisma.product.create({
    data: {
      ...
      description:
        "Una manta de apego ultra suave para acompañar a tu bebé en sus sueños. La cabeza de conejito es ideal para que las manitas pequeñas la agarren.",
      price: 2500,
