<footer class="flex flex-col gap-6 px-5 py-10 text-center @container">
  <div class="flex flex-wrap items-center justify-center gap-6 @[480px]:flex-row @[480px]:justify-around">
    <a class="text-[#955074] text-base font-normal leading-normal min-w-40" href="/contact">Contacto</a>
    <a class="text-[#955074] text-base font-normal leading-normal min-w-40" href="/faq">Preguntas frecuentes</a>
    <a class="text-[#955074] text-base font-normal leading-normal min-w-40" href="/privacy">Política de privacidad</a>
  </div>
