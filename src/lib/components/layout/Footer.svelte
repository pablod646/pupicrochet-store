...
<footer class="bg-gray-800 py-8 text-white">
  ...
  >
    <div class="w-full md:w-1/3 text-center md:text-left mb-4 md:mb-0">
      <p>&copy; {currentYear} PupiCrochet. Todos los derechos reservados.</p>
    </div>
    <div class="w-full md:w-2/3 text-center md:text-right">
      <nav>
        <ul class="flex justify-center md:justify-end space-x-4">
          ...
          <li>
            <a href="/faq" class="hover:text-gray-400">Preguntas frecuentes</a>
          </li>
          <li>
            <a href="/privacy" class="hover:text-gray-400"
