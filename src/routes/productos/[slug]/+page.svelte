        ...
        <div class="grid grid-cols-5 gap-2">
          {#each product.images as image, i (image.url)}
            <button
              ...
              class="aspect-square w-full overflow-hidden rounded-md border-2 {selectedImage ===
              image.url
                ? 'border-purple-600'
                : 'border-transparent'} transition focus:outline-none focus:ring-2 focus:ring-purple-500"
            >
              <img
                src={image.url}
        ...
        <div class="mt-8">
          ...
          <form method="POST" action="?/addToCart" class="mt-6">
            ...
            <div class="flex items-center gap-4">
              <label for="quantity" class="text-lg font-medium text-gray-700"
                >Cantidad:</label
              >
              <input
                type="number"
            ...
            <button
              class="mt-6 w-full bg-purple-600 text-white font-bold py-3 px-6 rounded-md hover:bg-purple-700 transition focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
            >
              Agregar al Carrito
            </button>
          </form>
...
{:else}
  <div class="flex flex-col items-center justify-center h-96">
    ...
    <a href="/" class="mt-6 text-purple-600 hover:underline"
